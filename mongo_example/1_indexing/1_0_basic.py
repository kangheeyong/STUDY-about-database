...
if __name__ == '__main__':
    ...
    with open('1_0_basic/data_1.json', 'w') as fp:
        json.dump(data, fp, indent=4)

    data = Case2.objects.filter(c="c-1").explain()
    with open('1_0_basic/data_2.json', 'w') as fp:
        json.dump(data, fp, indent=4)

    data = Case3.objects.filter(c="c-1").explain()
    with open('1_0_basic/data_3.json', 'w') as fp:
        json.dump(data, fp, indent=4)

    data = Case4.objects.filter(c="c-1").explain()
    with open('1_0_basic/data_4.json', 'w') as fp:
        json.dump(data, fp, indent=4)
